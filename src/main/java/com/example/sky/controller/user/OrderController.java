...
public class OrderController {
    ...
    public Result<PageQueryVO> page(OrderPageQueryDTO orderPageQueryDTO) {
        log.info("用户历史订单查询：{}", orderPageQueryDTO);
        PageQueryVO pageQueryVO = orderService.page(orderPageQueryDTO);
